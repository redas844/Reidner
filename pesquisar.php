...
$result_curso = "SELECT * FROM cds WHERE nome LIKE '%$valor_pesquisar%'";
...
$result_cursos = "SELECT * FROM cds WHERE nome LIKE '%$valor_pesquisar%' limit $incio, $quantidade_pg";
			...
			<div class="page-header">
				<div class="row">
					<div class="col-sm-6 col-md-6">
						<h1 class="form-signin-heading"><font color="white" size="10">CDs</font></h1>
					</div>
					<div class="col-sm-6 col-md-6">
